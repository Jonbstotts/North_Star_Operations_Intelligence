...
public final class OverlayEffectsPanel extends JComponent {
    ...
    public OverlayEffectsPanel(){
        ...
        timer=new javax.swing.Timer(16,e->tick()); // desktop-first ~60 FPS animation cadence
        timer.start();
    }
    ...
    private double ambientScale(){
        // Celebration confetti gets visual priority without reducing normal desktop quality.
        return confettiActive()?.72:1.0;
    }
    ...
    /**
     * Enforces a deterministic ambient-particle budget to prevent runaway allocations.
    ...
    private void drawSnowflake(Graphics2D g2,Particle p){
        ...
        // Six-point snowflake with full branch detail on desktop-class hardware.
