...
public final class ThemeStyler {
        ...
        if(component instanceof JLabel label){
            ...
            tabs.setUI(new BasicTabbedPaneUI(){
                ...
                @Override protected void paintContentBorder(
                    ...
                    // Single-pane design: child cards provide grouping.
                }
    ...
    private static final class RoundedOutlineBorder extends AbstractBorder {
        ...
        @Override public void paintBorder(Component c,Graphics g,int x,int y,int w,int h){Graphics2D g2=(Graphics2D)g.create();g2.setRenderingHint(RenderingHints.KEY_ANTIALIASING,RenderingHints.VALUE_ANTIALIAS_ON);g2.setColor(color);g2.drawRoundRect(x,y,w-1,h-1,radius,radius);g2.dispose();}
    }
}
