...
public final class ThemeCoreV216 {
    ...
    /**
     * Kept for ThemeStyler compatibility. This method is now synchronous and
     * idempotent; it never starts a polling timer or performs delayed resizing.
     */
    ...
    /**
     * The sidebar is the canonical Dashboard navigation. Old route headers
     * still present in historical source builds are removed before first paint.
     */
